...
//    [self.textField becomeFirstResponder];
    ...
    for (int i =0 ; i<_num; i++) {
        ...
        UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(i*40+i*((self.frame.size.width-_num*40)/(_num-1)), self.frame.size.height-_lineHeight, 40, _lineHeight)];
    ...
    for (int i =0 ; i<_num; i++) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(i*40+i*((self.frame.size.width-_num*40)/(_num-1)),0, 40, self.frame.size.height-_lineHeight)];

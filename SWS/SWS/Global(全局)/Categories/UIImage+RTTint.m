...
- (UIImage*)rt_gradientImageWithStartColor:(UIColor*)startColor endColor:(UIColor *)endColor {
    CGRect imageRect = CGRectMake(0.0f, 0.0f, self.size.width, self.size.height);
    ...
    CGPoint startPoint = CGPointMake(CGRectGetMinX(imageRect), CGRectGetMidY(imageRect));
    CGPoint endPoint = CGPointMake(CGRectGetMaxX(imageRect), CGRectGetMidY(imageRect));

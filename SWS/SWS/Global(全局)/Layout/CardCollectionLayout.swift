...
class CardCollectionLayout:UICollectionViewFlowLayout {
    ...
    private let scaleFactor:CGFloat = 0//.0005
    ...
    override func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        ...
        return CGPoint(x: min(max(proposedContentOffset.x+ofsetX, 0), collectionView!.contentSize.width - collectionView!.bounds.size.width), y: proposedContentOffset.y)
    }

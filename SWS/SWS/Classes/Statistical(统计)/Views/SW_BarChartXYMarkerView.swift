...
public class SW_BarChartAxisValueFormatter: NSObject, IAxisValueFormatter {
...
class SW_BarChartXYMarkerView: BalloonMarker {
    ...
    public override func refreshContent(entry: ChartDataEntry, highlight: Highlight) {
        ...
        let string = legendLabels[index-1]
            + ": "

...
class SW_StaffInfoFieldCell: Cell<String>, CellType, UITextFieldDelegate {
    ...
    private var rowForCell : SW_StaffInfoFieldRow? {
        return row as? SW_StaffInfoFieldRow
    }
    ...
    public override func setup() {
        ...
        titleWidthConstraint.constant = rowForCell.rawTitle.size(titleLabel.font, width: 0).width
...
final class SW_StaffInfoFieldRow: Row<SW_StaffInfoFieldCell>, RowType {
    ...
    required public init(tag: String?) {
        ...
        cellProvider = CellProvider<SW_StaffInfoFieldCell>(nibName: "SW_StaffInfoFieldCell")
    }

...
- (void)cmdMessagesDidReceive:(NSArray *)aCmdMessages
{
    for (EMMessage *message in aCmdMessages) {
        ...
        if ([action isEqualToString:@"inviteToJoinConference"]) {
            ...
            [[self.mainController getCurrentNaVController] pushViewController:confController animated:NO];
...
- (void)pushConferenceControllerWithType:(EMCallType)aType
{
    ...
    [[self.mainController getCurrentNaVController] presentViewController:alertController animated:YES completion:nil];
}
